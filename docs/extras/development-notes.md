...
**EDIT** (2025-11-29): We have switched from `::after` to `::before` because it makes debugging a little bit easier. (In the Developer Tools, you won't have to scroll all the way to the bottom of the `option`s list to see the styles for the message.)
