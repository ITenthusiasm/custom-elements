...
import { useId, useState, useRef, useCallback } from "preact/hooks";
...
export default function MenuExample() {
  ...
  const mountMenu = useCallback((menu: MenuElement | null) => {
    if (!menu) return; // NOTE: Preact invokes callback refs with `null` on unmount
  ...
  function handleButtonGroupClick(event: TargetedMouseEvent<HTMLElement>) {
